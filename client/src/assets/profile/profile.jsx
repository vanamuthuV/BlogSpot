                ...
                <div className="w-full">
                  <div className="flex flex-row items-center justify-between">
                    <div className="w-3/4">
                      ...
                      <h1 className="flex flex-row items-center text-xl font-semibold tex-gray-600 max-md:text-sm">
                          ...
                          <Tooltip title="Verified">
                            <div>
                              <svg
                                ...
                                viewBox="0 0 24 24"
                                fill="currentColor"
                                class="size-6 ml-1 text-green-500 max-md:size-4"
                              >
                                <path
                                  fill-rule="evenodd"
                          ...
                          <Tooltip title="Unverified">
                            <div>
                              <svg
                                ...
                                viewBox="0 0 24 24"
                                fill="currentColor"
                                class="size-6 ml-1 text-red-500 max-md:size-4"
                              >
                                <path
                                  fill-rule="evenodd"
